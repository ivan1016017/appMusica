...
import { AlbumJoinUserComponent } from './album/album-join-user/album-join-user.component';
import { CancionJoinUserComponent } from './cancion/cancion-join-user/cancion-join-user.component';
...
const routes: Routes = [
  ...
  {
    path: 'albumes/join/coleccionistas/:albumId/:userId/:userToken',
    component: AlbumJoinUserComponent
  },
  {
  ...
  {
    path: 'canciones/join/coleccionistas/:cancionId/:userId/:userToken',
    component: CancionJoinUserComponent
  },
